...
Route::group(['prefix' => 'pay', 'namespace' => 'Pay', 'middleware' => ['dujiaoka.pay_gate_way']], function () {
	...
	// Coinpay
    Route::get('coinpayvip/{payway}/{orderSN}', 'CoinpayvipController@gateway');
    Route::post('coinpayvip/notify_url', 'CoinpayvipController@notifyUrl');
    Route::get('coinpayvip/return_url', 'CoinpayvipController@returnUrl')->name('coinpayvip-return');
